...
{
    public partial class ProcessListLayoutPanel : UserControl
    {
        ...
        public int                           childrenCount         { get => _children.Count; }   //子の作業工程数
        public int                           selectionCount        { get => _selections.Count; } //現在選択している作業工程数
        public Size                          layoutPanelSize       { get => _listItemLayoutPanel.Size; set => _listItemLayoutPanel.Size = value; }//子の作業工程リストレイアウト用パネルのサイズ
        public TableLayoutRowStyleCollection layoutPanelLineStyles { get => _listItemLayoutPanel.RowStyles; }//子の作業工程リストレイアウト用パネルの行スタイルリスト
        //-----------------------------------------------------------------------------
        ...
        public ProcessListLayoutPanel( Entity pEntity )
        {
            InitializeComponent();
            Setup(pEntity);
        }
